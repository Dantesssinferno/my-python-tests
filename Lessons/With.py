...
# В Python существует специальный синтаксис with, который позволяет упростить работу с объектами,
# требующими очистки ресурсов после использования.
# Одним из наиболее распространенных примеров использования with является работа с файлами.
