...
# Напишите функцию new_function(), которая запрашивает у пользователя три числа.
# Если первое число больше третьего, то вывести на печать - Good, если равно или меньше - Bad
...
# Напишите функцию new_function(), которая запрашивает у пользователя три числа. Если первое число больше третьего, то вывести на печать - Good, если равно или меньше - Bad
def new_function():
    num_4 = int(input())
